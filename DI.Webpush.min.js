...
null == window.DI.WebPush && (window.DI.WebPush = {}),
!function(i, s) {
    "use strict";
    var e = "model"
      , o = "name"
                ...
                for (e = o = 0; e < l.length && !n; )
                    if (n = l[e++].exec(i))
                        for (r = 0; r < w.length; r++)
                            d = n[++o],
                            "object" == typeof (a = w[r]) && a.length > 0 ? 2 == a.length ? "function" == typeof a[1] ? this[a[0]] = a[1].call(this, d) : this[a[0]] = a[1] : 3 == a.length ? "function" != typeof a[1] || a[1].exec && a[1].test ? this[a[0]] = d ? d.replace(a[1], a[2]) : void 0 : this[a[0]] = d ? a[1].call(this, d, a[2]) : void 0 : 4 == a.length && (this[a[0]] = d ? a[3].call(this, d.replace(a[1], a[2])) : void 0) : this[a] = d || void 0;
                t += 2
            }
        },
        str: function(i, s) {
      ...
      , m = function(s, e) {
        if ("object" == typeof s && (e = s,
        s = void 0),
        !(this instanceof m))
            return new m(s,e).getResult();
        ...
        return this.getBrowser = function() {
            ...
            return w.rgx.call(i, o, r.browser),
            i.major = l.major(i.version),
            i
        }
        ,
        ...
        this.getDevice = function() {
            ...
            return w.rgx.call(i, o, r.device),
            i
        }
        ,
        this.getEngine = function() {
            ...
            return w.rgx.call(i, o, r.engine),
            i
        }
        ,
        this.getOS = function() {
    ...
    exports.UAParser = m) : "function" == typeof define && define.amd ? define(function() {
        return m
    }) : i && (i.UAParser = m);
...
(function(e) {
    "use strict";
    var n, o = {
        "messagingSenderId": "1011694409186"
    }, t = "14911:FTjBtIivqW2D6dFKWW9qLrphY9CrY0jO", i = {
        "Unknown": 0,
        "Chrome": 4,
        "Firefox": 8,
        "Edge": 16,
        ...
        "MotorolaOS": 208,
        "HTC": 209
    }, c = !1, s = !1, l = (new UAParser).getResult();
    function d(e) {
        Notification && "granted" === Notification.permission && !document.hidden && (s ? e && e.call() : (s = !0,
        "serviceWorker"in navigator && navigator.serviceWorker.register("/DI.WebPush-sw.js", {
            scope: "/di-push-scope",
            updateViaCache: "all"
        }).then(function(o) {
            n.useServiceWorker(o),
            e && e.call()
        }).catch(function(e) {
    ...
    function f() {
        var e = null != T()
          , o = T() != n.messagingSenderId;
        return e && o
    }
    function u() {
        var e = window.localStorage.getItem("PushToken");
        null != e && I(e)
    }
    function g() {
    ...
    function I(e) {
        if (null != e) {
            var n = window.localStorage.getItem("PushToken");
            if (!k() || null !== n && n !== e || g() && !w() || f()) {
                var o = window.localStorage.getItem("ContactIdentifier")
                  , s = null
                  , l = null
                  , d = null;
                null != o && ("contact" == (s = (o = JSON.parse(o)).identificationType) || "sendlog" == s ? l = o.id + ":" + o.key : "project" == s && (d = o.keys));
                var u = {
                    ContactIdentificationType: s,
                    ContactIdentification: l,
                    Fields: d,
                    Token: e,
                    ...
                    idPlatformPush: m(i),
                    idDeviceType: p(r),
                    idDevicePlatform: S(a)
                };
                !0 === c && console.log("Sending token to server with data: ", u);
                var I = t.split(":")
                  , b = new Headers({
                    "Content-Type": "text/plain"
                })
                  , T = JSON.stringify(u);
                fetch("https://jfc.ofsys.com/T/OFC4/WPT/" + I[0] + "/" + I[1], {
                    mode: "cors",
                    method: "POST",
                    headers: b,
                    body: T
                ...
                !0 === c && console.log("Token already sent to server so won't send it again unless it changes");
            window.localStorage.setItem("PushToken", e)
        }
    }
    function m(e) {
        var n = l.browser.name;
        return e["Opera" === n || "Chrome" === n || "Firefox" === n ? n : "Edge" === n && 3 === p(r) ? n : "Unknown"]
    }
    function p(e) {
        var n, o = (n = l.device.type) && n[0].toUpperCase() + n.slice(1), t = l.os.name;
        return e["Mobile" === o || "Tablet" === o ? o : "Windows" === t || "Mac OS" === t ? "Desktop" : "Unknown"]
    }
    function S(e) {
        var n = l.os.name;
        return e["Mac OS" === n ? "MacOS" : void 0 !== n ? n : "Unknown"]
    }
    function k() {
    ...
    function b() {
        var e = "Notification"in window
          , n = firebase.messaging.isSupported()
          , o = "serviceWorker"in navigator
          , t = null != i && 0 !== m(i);
        return e && n && o && t
    }
    function T() {
        return window.localStorage.getItem("firebaseID")
    }
    function D(e) {
        if (b()) {
            if (void 0 === e || null == e || !e.match(/^[A-z]{2}$/g))
                throw "DI.WebPush.RequestPermission : invalid language, the language must be 2 alphabeticals characters";
            window.localStorage.setItem("language", e),
            n.requestPermission().then(function() {
                d(function() {
                    n.getToken().then(function(e) {
                        var o;
                        e ? (I(e),
                        o = n.messagingSenderId,
                        window.localStorage.setItem("firebaseID", o)) : (!0 === c && console.log("No Instance ID token available. Request permission to generate one."),
                        y(!1))
                    }).catch(function(e) {
                        !0 === c && console.log("An error occurred while retrieving token. ", e),
                        y(!1)
                    })
                })
            }).catch(function(e) {
                !0 === c && console.log("Unable to get permission to notify.", e)
            })
        } else
            console.log("The method (DI.WebPush.RequestPermission) is not supported by your browser.")
    }
    function P() {
        d(function() {
            n.getToken().then(function(e) {
                n.deleteToken(e).then(function() {
                    !0 === c && console.log("Token deleted."),
                    y(!1),
                    localStorage.removeItem("firebaseID");
                    var e = v();
                    null != e ? D(e) : c && console.log("Language not set. Couldnt get a new token")
                }).catch(function(e) {
                    !0 === c && console.log("Unable to delete token. ", e)
                })
            }).catch(function(e) {
                !0 === c && console.log("Error retrieving Instance ID token. ", e)
            })
        })
    }
    e.Init = function() {
        b() && (firebase.initializeApp(o),
        (n = firebase.messaging()).onTokenRefresh(function() {
            d(function() {
                n.getToken().then(function(e) {
                    y(!1),
                    I(e)
                }).catch(function(e) {
                    !0 === c && console.log("Unable to retrieve refreshed token", e),
                    P()
                })
            })
        }),
        n.onMessage(function(e) {
            !0 === c && console.log("onMessage :Message received. ", e),
            function(e) {
                Notification && "granted" === Notification.permission && !document.hidden && navigator.serviceWorker.getRegistration("/di-push-scope").then(function(n) {
        ...
        function() {
            if (!g()) {
                var e = function() {
                    ...
                    if (null == e || "" == e)
                        return n;
                    for (var o = decodeURIComponent(e).split("&"), t = 0; t < o.length; t++) {
                        var i = o[t].split("=");
                        n[i[0]] = i[1]
                    }
                    return n
                ...
                if (void 0 !== e.oft_id && void 0 !== e.oft_k) {
                    ...
                    window.localStorage.setItem("ContactIdentifier", JSON.stringify(n))
        ...
        f() || null == T() ? (!0 === c && console.log("FirebaseID changed or wasnt save. Will Delete and get new a token automatically"),
        P()) : k() && g() && !w() && u(),
        c = window.location.search.slice(1).split("&").indexOf("ofsysDebug=1") > -1)
    }
    ,
    e.ResetIdentify = function() {
        h(!1),
        window.localStorage.removeItem("ContactIdentifier"),
        !0 === c && console.log("Identity reset")
    }
    ,
    e.Identify = function() {
        if (g())
            !0 === c && console.log("Contact already identified, " + window.localStorage.getItem("ContactIdentifier"));
        else {
            var e = {};
            if (1 === arguments.length && arguments[0].constructor === {}.constructor)
                ...
                for (var o = 0; o < arguments[0].length; o++)
                    o % 2 == 0 && "string" == typeof (n = arguments[0][o]) && 0 === n.indexOf("f_") && (e[n] = arguments[0][o + 1]);
            else {
                if (!(arguments.length > 0 && arguments.length % 2 == 0))
                    throw "invalid parameters";
                for (o = 0; o < arguments.length; o++)
                    o % 2 == 0 && "string" == typeof (n = arguments[o]) && 0 === n.indexOf("f_") && (e[n] = arguments[o + 1])
            }
            var t = {
                keys: e,
            ...
            !0 === c && console.log("Contact identified")
        }
        k() && !w() && u()
    }
    ,
    ...
    e.isSubscribed = function() {
        return 1 == window.localStorage.getItem("sentToServer") && "granted" == Notification.permission
    }
    ,
